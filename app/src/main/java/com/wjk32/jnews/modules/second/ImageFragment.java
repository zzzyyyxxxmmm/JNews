...
public class ImageFragment extends Fragment implements ImageContract.View{
    ...
    @BindView(R.id.tab_bar_02_recyclerview)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setPresenter(null);
        mPresenter.loadImage(false);
        return view;
    }

    @Override
    public void showImage(List<ImageEntity.HitsBean> imageList, boolean refresh) {

        ImageAdapter  imageAdapter=new ImageAdapter(R.layout.tab_bar_02_item,imageList,getContext());
